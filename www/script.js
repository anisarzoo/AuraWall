class AuraWall {
    ...
    attachEventListeners() {
        ...
        this.setWallpaperBtn = document.getElementById('set-wallpaper-btn');
        if (this.setWallpaperBtn) {
            this.setWallpaperBtn.addEventListener('click', () => this.setWallpaper());
        }
    ...
    setWallpaper() {
        if (window.Capacitor && window.Capacitor.Plugins) {
            this.showToast('Select "AuraWall" from the Wallpaper list');
            // Deep link to Android Wallpaper picker
            window.location.href = "intent:#Intent;action=android.service.wallpaper.LIVE_WALLPAPER_CHOOSER;end";
        } else {
            this.showToast('Use our Android App for Live Wallpaper support!');
        }
    }
